...
## about-activity — About 站点综合活动
- **关键词:** About, 热力图, 站点活动, 访问量, 发布, 更新, 评论, 留言, 项目更新, 365天, 综合等级
- **需求:** 最近 365 天活动聚合, 站点时区日期归桶, 分类明细, 独立归一化, 等权综合等级, 缺失日期补零, 数据源失败明确返回, 桌面 hover, 移动端 click, GitHub 热力图独立展示
