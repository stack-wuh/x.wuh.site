...
title: 博客详情页排版
domain: blog
keywords: [博客详情, 排版, 字号, 行高, 对比度, 封面, 相关文章, 标签链接, 阅读余韵, 书页式设计语言, 章节记号, 首字下沉, 注记式页头, 朱砂藏印标签, 分享行, 结构线, Divider, 骨架屏, skeleton, loading]
scope:
  - apps/site/app/post
